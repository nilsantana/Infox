...
public class TelaLogin extends javax.swing.JFrame {
    ...
    //variável de conexão do BD
    Connection conexao = null;
    //variáveis complementares de manipulação BD
    ...
    public void logar() {
        ...
        try {
            // As linhas abaixo preparam a consulta ao banco em funão do que foi digitado nas caixaa de texto o
            //o ? é substuido pelo conteúdo das vairiáveis
            
            pst = conexao.prepareStatement(sql);
            pst.setString(1, txtUsuario.getText());
            pst.setString(2, txtSenha.getText());
            //a inha abaio executa a consulta
            rs = pst.executeQuery();
    ...
    public TelaLogin() {
        initComponents();
        //chamando o metodo conector após carregar tela
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(381, 217));
